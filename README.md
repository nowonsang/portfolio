...
```sh
'VR 화재안전 교육 플랫폼은' AR/VR 증강/가상현실속 화재상황시 대피요령을 학습함으로써 실제로 이와같은 상황이 발생했을때
...
```sh
'VR 화재대처 교육 플랫폼은' (주)제튼 회사에서 배웠던 기술들을 활용하여 졸업 프로젝트로 가상세계에서의 화재상황을 발생시켜
화재시 대피하는 요령을 VR을 통해 학습하는 플랫폼을 만들었습니다
```
